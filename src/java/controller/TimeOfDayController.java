 ...
 * @author Nolan
 */
@WebServlet(name = "TimeOfDayController", urlPatterns = {"/TimeOfDayController"})
public class TimeOfDayController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Data Processing
        WelcomeService nms = new WelcomeService();
